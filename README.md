...
This marketplace contains four plugins that can be installed independently:
...
| [contextd](docs/plugins/contextd.md) | 1.3.0 | 5 skills, 2 agents, 8 commands | Cross-session memory via MCP |
